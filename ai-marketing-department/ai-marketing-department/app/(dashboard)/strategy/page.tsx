...
const strategyTabs: { key: StrategyTab; label: string; icon: typeof Brain }[] = [
  { key: "autopilot", label: "Autopilot", icon: Rocket },
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <div className="flex items-center gap-2">
            ...
            <h1 className="text-base font-semibold text-stone-900">Estrategia</h1>
          </div>
          <p className="text-xs text-stone-500 mt-0.5">
            Autopilot, marca e insights estratégicos
          </p>
        </div>
        <div className="flex items-center gap-2">
      ...
      {activeStrategyTab === "autopilot" && (
        <>
          {/* Phase Progress Bar */}
          {isProfileComplete && <PhaseProgress />}
        ...
        <div className="space-y-6">
          {brandProfile ? (
            ...
            <div className="text-center py-12">
              <Palette className="h-8 w-8 mx-auto mb-3 text-[var(--text-tertiary)]" />
              <p className="text-sm text-[var(--text-secondary)] mb-3">No hay perfil de marca configurado.</p>
              <Link href="/brand" className="text-orange-600 hover:underline text-sm">Crear perfil de marca</Link>
            </div>
          )}
        </div>
      )}
      ...
      {activeStrategyTab === "insights" && (
        <div className="space-y-6">
          {brandProfile && isProfileComplete ? (
            <>
              <ContentPillarsPanel brandProfileId={brandProfile._id} />
            ...
            <div className="text-center py-12">
              <BarChart3 className="h-8 w-8 mx-auto mb-3 text-[var(--text-tertiary)]" />
              <p className="text-sm text-[var(--text-secondary)] mb-3">
                {!brandProfile
                  ? "No hay perfil de marca configurado."
                  : "Completa tu perfil de marca para ver insights."}
              </p>
              <Link href="/brand" className="text-orange-600 hover:underline text-sm">
                {!brandProfile ? "Crear perfil de marca" : "Completar perfil"}
              </Link>
            </div>
          )}
        </div>
