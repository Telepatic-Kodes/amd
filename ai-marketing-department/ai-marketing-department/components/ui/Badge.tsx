...
const variantStyles: Record<BadgeVariant, string> = {
  default: "bg-[var(--surface-1)] text-[var(--text-secondary)] border-[var(--border)]",
  success: "bg-[var(--badge-green-bg)] text-green-700 border-green-200",
  warning: "bg-amber-50 text-amber-700 border-amber-200",
  error: "bg-[var(--badge-red-bg)] text-[var(--badge-red-text)] border-[var(--badge-red-bg)]",
  info: "bg-[var(--accent-subtle)] text-orange-700 border-orange-200",
};
