  ...
  if (variant === "icon") {
    return (
      <button
        ...
        className="p-1.5 rounded-lg bg-[var(--surface-1)]/90 backdrop-blur-sm hover:bg-[var(--surface-2)] text-[var(--text-tertiary)] hover:text-purple-400 transition-colors disabled:opacity-50"
