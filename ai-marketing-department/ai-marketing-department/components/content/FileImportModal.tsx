          ...
          >
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-2 bg-zinc-800 border border-zinc-700 rounded-lg text-zinc-100 placeholder-zinc-500 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent"
                    />
                  </div>
            ...
            <div className="flex items-center justify-end gap-3 p-6 border-t border-zinc-800">
              {step === "upload" ? (
                <button
                  onClick={onClose}
                  className="px-4 py-2 bg-zinc-800 hover:bg-zinc-700 text-zinc-300 rounded-lg transition-colors font-medium min-h-[44px]"
                >
                  Cancelar
                </button>
              ) : (
                <>
                  ...
                  <button
                    ...
                    className="px-6 py-2 bg-indigo-600 hover:bg-indigo-700 text-white rounded-lg transition-colors font-medium flex items-center gap-2 min-h-[44px]"
                  >
