...
export function NextActionCard() {
  ...
  return (
    <AnimatePresence>
      ...
      >
        <div className="relative group rounded-xl border border-[var(--border)] bg-gradient-to-r from-stone-100/80 to-stone-900/50 p-4 md:p-5 overflow-hidden">
          ...
          <div className="relative flex items-center gap-4">
            ...
            <Link
              href={action.href}
              className="flex items-center gap-1.5 px-4 py-2 rounded-lg bg-[var(--accent)]/10 text-[var(--accent)] text-sm font-medium hover:bg-[var(--accent)]/20 transition-colors flex-shrink-0"
            >
              Ir
            ...
            <button
              ...
              className="p-1.5 rounded-lg text-[var(--text-secondary)] hover:text-[var(--text-tertiary)] hover:bg-[var(--surface-2)] transition-colors flex-shrink-0"
