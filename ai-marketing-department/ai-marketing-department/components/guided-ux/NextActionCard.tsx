...
export function NextActionCard() {
  ...
  return (
    <AnimatePresence>
      ...
      >
        <div className="relative group rounded-xl border border-zinc-800 bg-gradient-to-r from-zinc-900/80 to-zinc-950/80 p-4 md:p-5 overflow-hidden">
          ...
          <div className="relative flex items-center gap-4">
            ...
            <Link
              href={action.href}
              className="flex items-center gap-1.5 px-4 py-2 rounded-lg bg-indigo-500/10 text-indigo-400 text-sm font-medium hover:bg-indigo-500/20 transition-colors flex-shrink-0"
            >
              Ir
            ...
            <button
              ...
              className="p-1.5 rounded-lg text-zinc-600 hover:text-zinc-400 hover:bg-zinc-800 transition-colors flex-shrink-0"
