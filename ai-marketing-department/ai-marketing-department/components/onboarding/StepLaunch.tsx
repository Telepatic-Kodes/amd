...
function SummaryRow({ icon: Icon, label, value }: { icon: React.ElementType; label: string; value: string }) {
  return (
    <div className="flex items-start gap-3 p-3 rounded-lg bg-[var(--surface-1)]/50">
  ...
  return (
    <div className="space-y-6 max-w-lg mx-auto">
      <div className="text-center space-y-2">
        ...
        <h2 className="text-2xl font-bold text-[var(--text-primary)]">¡Listo para comenzar!</h2>
        <p className="text-[var(--text-tertiary)] text-sm">Revisa tu configuración y lanza tu departamento.</p>
      </div>
