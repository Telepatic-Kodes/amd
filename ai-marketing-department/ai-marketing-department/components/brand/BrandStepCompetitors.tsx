  ...
  return (
    <div className="p-4 rounded-lg bg-gray-50 border border-gray-200 space-y-3">
      ...
      <input
        ...
        className="w-full px-3 py-2 rounded-lg bg-white border border-gray-200 text-gray-900 placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-indigo-500/50 text-sm transition"
      />
      ...
      <div className="flex items-center gap-2">
        ...
        <input
          ...
          className="flex-1 px-3 py-2 rounded-lg bg-white border border-gray-200 text-gray-900 placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-indigo-500/50 text-sm transition"
        />
      </div>

      <div className="flex items-start gap-2">
        <StickyNote className="w-3.5 h-3.5 text-gray-400 shrink-0 mt-2.5" />
        <textarea
          value={competitor.notes}
          onChange={(e) => onUpdate({ ...competitor, notes: e.target.value })}
          placeholder="Notas: qué hacen bien, qué hacen mal..."
          rows={2}
          className="flex-1 px-3 py-2 rounded-lg bg-white border border-gray-200 text-gray-900 placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-indigo-500/50 text-sm transition resize-none"
        />
      </div>
    </div>
  );
      ...
      <div className="space-y-6">
        ...
        <div className="space-y-3">
          ...
          <button
            ...
            className="w-full py-3 rounded-lg border-2 border-dashed border-gray-200 text-gray-400 hover:border-orange-500/50 hover:text-orange-400 transition flex items-center justify-center gap-2 text-sm font-medium"
          >
        ...
        <div className="space-y-3">
          <label className="text-sm font-medium text-gray-700 flex items-center gap-2">
            <Globe className="w-4 h-4 text-indigo-400" /> URLs de referencia
          </label>
