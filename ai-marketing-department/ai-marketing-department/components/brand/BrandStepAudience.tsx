      ...
      <div className="space-y-2">
        ...
        <div className="flex gap-2">
          ...
          <button
            ...
            className="px-2.5 py-2 rounded-lg bg-indigo-500/10 text-indigo-400 hover:bg-indigo-500/20 transition"
          >
    ...
    <div className="space-y-8 max-w-lg mx-auto">
      ...
      <div className="space-y-4">
        ...
        <button
          type="button"
          onClick={addSegment}
          className="w-full py-3 rounded-lg border-2 border-dashed border-gray-200 text-gray-400 hover:border-indigo-500/50 hover:text-indigo-400 transition flex items-center justify-center gap-2 text-sm font-medium"
        >
