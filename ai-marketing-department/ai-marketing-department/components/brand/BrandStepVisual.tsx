    ...
    <div className="space-y-1.5">
      ...
      <div className="flex gap-2 items-center">
        <input
          ...
          className="w-9 h-9 rounded-lg cursor-pointer border border-stone-200 bg-transparent p-0.5"
        />
        <input
          type="text"
          value={value}
          onChange={(e) => onChange(e.target.value)}
          placeholder="#6366f1"
          className="flex-1 px-3 py-1.5 rounded-lg bg-white border border-stone-200 text-stone-900 placeholder:text-stone-400 focus:outline-none focus:ring-2 focus:ring-orange-500/50 text-xs transition font-mono"
        />
      </div>
    </div>
  );
      ...
      <div className="space-y-8">
        ...
        <div className="space-y-3">
          <label className="text-sm font-medium text-stone-700 flex items-center gap-2">
            <Palette className="w-4 h-4 text-orange-400" /> Paleta de colores
          </label>
          ...
          {/* Color preview strip */}
          <div className="flex gap-1 mt-3 rounded-lg overflow-hidden border border-stone-200">
            {COLOR_FIELDS.map((field) => (
              <div
                key={field.key}
        ...
        <div className="space-y-3">
          <label className="text-sm font-medium text-stone-700 flex items-center gap-2">
            <Type className="w-4 h-4 text-orange-400" /> Tipografias
          </label>
          <div className="grid grid-cols-2 gap-4">
            <div className="space-y-1.5">
              <label className="text-xs text-stone-500">Fuente principal (titulos)</label>
              <select
                value={data.fontPrimary}
                onChange={(e) => onChange({ fontPrimary: e.target.value })}
                className="w-full px-3 py-2 rounded-lg bg-white border border-stone-200 text-stone-900 text-sm focus:outline-none focus:ring-2 focus:ring-orange-500/50 transition"
              >
            ...
            <div className="space-y-1.5">
              <label className="text-xs text-stone-500">Fuente secundaria (cuerpo)</label>
              <select
        ...
        <div className="space-y-3">
          <label className="text-sm font-medium text-stone-700 flex items-center gap-2">
            <ImageIcon className="w-4 h-4 text-orange-400" /> Logo
          </label>
          <textarea
            ...
            rows={2}
            className="w-full px-4 py-3 rounded-lg bg-stone-50 border border-stone-200 text-stone-900 placeholder:text-stone-400 focus:outline-none focus:ring-2 focus:ring-orange-500/50 transition resize-none text-sm"
          />
          <div className="px-3 py-2 rounded-lg bg-stone-50 border border-dashed border-stone-300 text-center">
            <p className="text-xs text-stone-400">
              ...
              El campo <code className="text-stone-500">logoStorageId</code> ya esta preparado en el schema.
            </p>
          </div>
        </div>
        ...
        <div className="space-y-2">
          <label className="text-sm font-medium text-stone-700 flex items-center gap-2">
            <Type className="w-4 h-4 text-orange-400" /> Notas de estilo
          </label>
          <textarea
        ...
        <div className="space-y-2">
          <label className="text-sm font-medium text-stone-700 flex items-center gap-2">
            <Eye className="w-4 h-4 text-orange-400" /> Vista previa
          </label>
          <div
            className="rounded-lg overflow-hidden border border-stone-200 shadow-sm"
            style={{
