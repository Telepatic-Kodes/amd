    ...
    <div className="space-y-2">
      ...
      <div className="flex gap-2 items-center">
        ...
        <input
          ...
          onChange={(e) => onChange(e.target.value)}
          placeholder="#6366f1"
          className="flex-1 px-3 py-2 rounded-lg bg-white border border-stone-200 text-stone-900 placeholder:text-stone-400 focus:outline-none focus:ring-2 focus:ring-orange-500/50 text-sm transition font-mono"
        />
      </div>
    </div>
  );
      ...
      <div className="space-y-6">
        ...
        <div className="space-y-3">
          <label className="text-sm font-medium text-stone-700 flex items-center gap-2">
            <Palette className="w-4 h-4 text-orange-400" /> Colores de marca
          </label>
          ...
          {(data.primaryColor || data.secondaryColor) && (
            <div className="flex gap-2 mt-2">
              {data.primaryColor && (
                <div
                  className="w-full h-8 rounded-lg border border-stone-200"
